...
options(max.print=15000) # set max print lines
...
flim<-0.8 # Sacado del plot del yield
...
mod_path=paste0(getwd(), "/Model/M0 base model/", sep="")  # mod_path
